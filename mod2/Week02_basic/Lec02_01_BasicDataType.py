...
# %%
# TRY AGAIN
# without the int addition in first part, python will literally put 2 of the integer in a row
userin = int(input("What is your favorite integer?"))
print(f'Your fav: {userin}')
print(f'Your fav: doubled: {userin * 2}\n')

# OR
# Look up the eval() function in python, see what it does. if the expression is legal it is executed 
...
anothertuple = (atuple, alist)
print(anothertuple)
print(len(anothertuple))

dictionary = {"BAD":["bad":"sam", 2019:"year"], 4:"ok"}
print(dictionary)
...
alist = clist
print(clist[3])
# the square brackets can identify a term in the list by index number
...
# we made a list of a list so clist lists alist which is one list tripled now
