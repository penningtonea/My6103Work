...
alist[1::2] #this will include the index after 2, so more like counting the next 3 indexed values
#%%
# Also try 
alist[-4]
alist[-4:-2]
alist[-4:]
alist[-2:-4]
# the - sign here will count backwards by the number indicated
#%%
